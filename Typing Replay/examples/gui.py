...
from actions import (
    ...
    delete_selection, set_style, InsertTextAction
)
...
更多信息请访问项目文档。
    ...
    def play_script(self):
        ...
        try:
            ...
            # 设置回调
            self.scheduler.on_state_changed(self.update_preview)
    ...
    def _play_in_thread(self, speed):
        """在线程中播放"""
        try:
            self.scheduler.play(real_time=True, speed=speed)
